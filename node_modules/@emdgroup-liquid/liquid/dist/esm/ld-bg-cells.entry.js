...
import { g as getLdAssetPath } from './getLdAssetPath-fafc4af6.js';
...
let LdBgCells = class {
  ...
  render() {
    ...
    return (h(Host, { class: getClassNames(['ld-bg-cells', `ld-bg-cells--${this.type}`]) }, h("div", { class: "ld-bg-cells__pattern", part: "pattern", style: {
        '--ld-bg-cells-image': `url(${assetPath})`,
      } }), h("div", { class: "ld-bg-cells__content", part: "content" }, h("slot", null))));
  }
