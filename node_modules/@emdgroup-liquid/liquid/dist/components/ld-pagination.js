...
import { d as defineCustomElement$3 } from './ld-button2.js';
...
let LdPagination$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ldPaginationCss; }
};
LdPagination$1 = /*@__PURE__*/ proxyCustomElement(LdPagination$1, [1, "ld-pagination", {
    "hidePrevNext": [4, "hide-prev-next"],
    "hideStartEnd": [4, "hide-start-end"],
    ...
    "sticky": [2],
    "maxSliderColumns": [32],
    "renderMoreIndicators": [32],
    "renderSticky": [32],
    "slidableItems": [32],
    "sliderContent": [32],
    "visibleItemsInSlider": [32]
  }]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["ld-pagination", "ld-button", "ld-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-pagination":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdPagination$1);
      }
      break;
    case "ld-button":
      if (!customElements.get(tagName)) {
...
const LdPagination = LdPagination$1;
const defineCustomElement = defineCustomElement$1;

export { LdPagination, defineCustomElement };
