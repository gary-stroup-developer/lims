...
let LdAccordionToggle$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ldAccordionToggleCss; }
};
LdAccordionToggle$1 = /*@__PURE__*/ proxyCustomElement(LdAccordionToggle$1, [1, "ld-accordion-toggle", {
    "disabled": [4],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "ld-accordion-toggle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdAccordionToggle$1);
      }
      break;
    case "ld-icon":
      if (!customElements.get(tagName)) {
...
const LdAccordionToggle = LdAccordionToggle$1;
const defineCustomElement = defineCustomElement$1;

export { LdAccordionToggle, defineCustomElement };
