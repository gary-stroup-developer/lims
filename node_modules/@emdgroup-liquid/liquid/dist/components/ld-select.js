...
let LdSelect$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  initPopper() {
    ...
    this.popper = new Tether(Object.assign({ classPrefix: 'ld-tether', element: this.listboxRef, target: this.selectRef, attachment: 'top left', targetAttachment: 'bottom left', offset: this.mode ? '-4px 0' : '0 0', constraints: [
        {
          to: 'window',
          pin: true,
        },
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: getClassNames(cl), "aria-disabled": this.disabled || this.ariaDisabled, part: "root", onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, style: this.expanded
      ...
      return (h("li", { key: index, class: "ld-select__selection-list-item", style: { order: index + 1 + '' }, part: "selection-list-item" }, h("label", { class: "ld-select__selection-label" }, h("span", { class: "ld-select__selection-label-text", title: selection.text, part: "selection-label-text" }, selection.text), h("button", { disabled: this.disabled || this.ariaDisabled
        ...
        } }, h("svg", { class: "ld-select__btn-clear-single-icon", part: "icon-clear-single", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 12 12" }, h("title", null, "Clear"), h("path", { stroke: "#fff", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M2 2l8 8M2 10l8-8" }))), h("span", { class: "ld-select__selection-label-bg", part: "selection-label-bg" }))));
    }))) : (h("span", { class: "ld-select__btn-trigger-text-wrapper", title: triggerText, part: "trigger-text-wrapper" }, h("span", { class: "ld-select__btn-trigger-text", part: "trigger-text" }, triggerText))), ((_b = this.selected) === null || _b === void 0 ? void 0 : _b.length) && this.multiple ? (h("button", { class: "ld-select__btn-clear", disabled: this.disabled || this.ariaDisabled ? true : undefined, onClick: this.handleClearClick.bind(this), ref: (el) => (this.btnClearRef = el), part: "btn-clear focusable" }, h("svg", { class: "ld-select__btn-clear-icon", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 21 20", part: "icon-clear" }, h("title", null, "Clear all"), h("path", { fill: "currentColor", "fill-rule": "evenodd", d: "M10 20a10 10 0 100-20 10 10 0 000 20z", "clip-rule": "evenodd" }), h("path", { stroke: "#fff", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M6.67 6.67l6.67 6.66M6.67 13.33l6.67-6.66" })))) : (''), h("slot", { name: "icon" }), !this.hasCustomIcon && (h("svg", { class: getClassNames(triggerIconCl), role: 'presentation', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", part: "trigger-icon" }, h("path", { stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "3", d: "M3 6l5 4 5-4" }))))), h("ld-select-popper", { onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, popperClass: this.popperClass, ref: (el) => (this.listboxRef = el), role: "listbox", expanded: this.expanded, size: this.size, detached: detached, theme: this.theme }, h("div", { ref: (el) => (this.internalOptionsContainerRef = el), innerHTML: this.internalOptionsHTML, part: "options-container" })))));
  }
  get el() { return this; }
...
LdSelect$1 = /*@__PURE__*/ proxyCustomElement(LdSelect$1, [1, "ld-select", {
    "autofocus": [4],
    "disabled": [4],
    "form": [1],
    "invalid": [4],
    ...
    "selected": [1040],
    "size": [1],
    "tetherOptions": [1025, "tether-options"],
    "ariaDisabled": [32],
    "expanded": [32],
    "hasCustomIcon": [32],
    "hasMore": [32],
