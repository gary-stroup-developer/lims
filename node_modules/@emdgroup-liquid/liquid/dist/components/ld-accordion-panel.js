...
let LdAccordionPanel$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h(Host, { style: { '--ld-accordion-panel-max-height': this.maxHeight + 'px' }, class: cl, onTransitionEnd: this.onTransitionEnd }, h("div", { ref: (ref) => (this.contentRef = ref), class: "ld-accordion-panel__content" }, h("slot", null))));
  }
  get el() { return this; }
  static get style() { return ldAccordionPanelCss; }
};
LdAccordionPanel$1 = /*@__PURE__*/ proxyCustomElement(LdAccordionPanel$1, [1, "ld-accordion-panel", {
    "expanded": [32],
    "initialized": [32],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "ld-accordion-panel":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdAccordionPanel$1);
      }
      break;
  } });
}
...
const LdAccordionPanel = LdAccordionPanel$1;
const defineCustomElement = defineCustomElement$1;

export { LdAccordionPanel, defineCustomElement };
