...
let LdInput$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h(Host, { class: cl, onClick: this.handleClick }, h("slot", { name: "start" }), h("input", Object.assign({}, this.clonedAttributes, { autocomplete: this.autocomplete, onChange: this.handleChange, onInput: this.handleInput, onKeyDown: this.handleKeyDown, part: "input focusable", ref: (el) => (this.input = el), tabIndex: this.ldTabindex, value: this.value })), this.type === 'file' && (h("span", { class: "ld-input__placeholder", part: "placeholder" }, ((_b = this.input) === null || _b === void 0 ? void 0 : _b.value) || this.placeholder)), h("slot", { name: "end" })));
  }
  get el() { return this; }
...
LdInput$1 = /*@__PURE__*/ proxyCustomElement(LdInput$1, [1, "ld-input", {
    "accept": [1],
    "autocomplete": [1537],
    "autofocus": [4],
    "capture": [1],
