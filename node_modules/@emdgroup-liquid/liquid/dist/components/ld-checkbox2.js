...
let LdCheckbox = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h(Host, { part: "root", class: getClassNames(cl), onClick: this.handleClick }, h("input", Object.assign({}, this.clonedAttributes, { checked: this.checked, disabled: this.disabled, onChange: this.handleChange, onInput: this.handleInput, part: "input focusable", ref: (ref) => (this.input = ref), tabIndex: this.ldTabindex, type: "checkbox", value: this.value })), h("svg", { class: "ld-checkbox__check", part: "check", width: "14", height: "14", fill: "none", viewBox: "0 0 14 14", xmlns: "http://www.w3.org/2000/svg" }, h("path", { d: "M12 4L5.40795 10L2 6.63964", stroke: "currentColor", "stroke-width": "3", "stroke-linecap": "round", "stroke-linejoin": "round" })), h("div", { class: "ld-checkbox__box", part: "box" })));
  }
  get el() { return this; }
...
LdCheckbox = /*@__PURE__*/ proxyCustomElement(LdCheckbox, [1, "ld-checkbox", {
    "autofocus": [4],
    "checked": [1028],
    "disabled": [4],
    "form": [1],
