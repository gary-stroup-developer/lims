...
let LdSidenavScrollerInternal = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ldSidenavScrollerInternalCss; }
};
LdSidenavScrollerInternal = /*@__PURE__*/ proxyCustomElement(LdSidenavScrollerInternal, [1, "ld-sidenav-scroller-internal", {
    "hasShadowBottom": [32],
    "hasShadowTop": [32],
    "needsHRBottom": [32],
    "needsHRTop": [32],
