...
let LdAccordion$1 = class extends HTMLElement {
  ...
  get el() { return this; }
  static get style() { return ldAccordionCss; }
};
LdAccordion$1 = /*@__PURE__*/ proxyCustomElement(LdAccordion$1, [1, "ld-accordion", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "ld-accordion":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdAccordion$1);
      }
      break;
  } });
}
...
const LdAccordion = LdAccordion$1;
const defineCustomElement = defineCustomElement$1;

export { LdAccordion, defineCustomElement };
