...
let LdBgCells = class {
  ...
  render() {
    const assetPath = getLdAssetPath.getLdAssetPath(`./assets/${this.type}-cell.svg`);
    return (index.h(index.Host, { class: getClassNames.getClassNames(['ld-bg-cells', `ld-bg-cells--${this.type}`]) }, index.h("div", { class: "ld-bg-cells__pattern", part: "pattern", style: {
        '--ld-bg-cells-image': `url(${assetPath})`,
      } }), index.h("div", { class: "ld-bg-cells__content", part: "content" }, index.h("slot", null))));
  }
