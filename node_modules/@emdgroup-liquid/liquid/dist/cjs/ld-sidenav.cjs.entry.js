...
let LdSidenav = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: getClassNames.getClassNames(cl), role: "navigation", "aria-label": this.label }, !this.closable && this.collapsible && (index.h("button", { role: "switch", "brand-color": true, "aria-checked": this.collapsed ? 'false' : 'true', class: "ld-sidenav__toggle", onClick: this.toggleCollapsedState, part: "toggle" }, index.h("ld-icon", { part: "toggle-icon", size: "sm", name: "arrow-left", class: "ld-sidenav__toggle-icon" }), index.h("ld-sr-only", null, this.collapsed ? this.labelExpand : this.labelCollapse))), index.h("div", { class: "ld-sidenav__content" }, index.h("div", { class: "ld-sidenav__slot-container-top", part: "slot-container-top" }, index.h("slot", { name: "top" })), index.h("ld-sidenav-scroller-internal", { class: "ld-sidenav__scroller", part: "scroll-container" }, index.h("div", { class: "ld-sidenav__slot-container-default", part: "slot-container" }, index.h("slot", null))), index.h("div", { class: "ld-sidenav__slot-container-bottom", part: "slot-container-bottom" }, index.h("slot", { name: "bottom" })))));
  }
