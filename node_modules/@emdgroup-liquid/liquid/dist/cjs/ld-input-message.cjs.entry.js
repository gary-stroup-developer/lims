...
let LdInputMessage = class {
  ...
  render() {
    return (index.h(index.Host, { class: `ld-input-message ld-input-message--${this.mode}` }, index.h("ld-icon", { class: "ld-input-message__icon", name: this.mode, part: "icon", size: "sm" }), index.h("span", { "aria-live": "assertive" }, index.h("slot", null))));
  }
