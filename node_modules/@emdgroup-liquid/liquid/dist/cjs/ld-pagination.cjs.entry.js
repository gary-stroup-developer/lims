...
let LdPagination = class {
  constructor(hostRef) {
    ...
    this.renderItem = (itemNumber, showFrom, showTo) => {
      ...
      return (index.h("li", { "aria-hidden": isHidden ? 'true' : undefined, class: getClassNames.getClassNames([
        ...
        ]), key: itemNumber, style: { '--ld-pagination-item-pos': `${itemNumber - 1}` } }, index.h("ld-button", { "aria-current": isSelected ? 'true' : undefined, "aria-label": isHidden ? undefined : `${this.itemLabel} ${itemNumber}`, "ld-tabindex": isHidden ? -1 : undefined, mode: "ghost", onClick: () => {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "navigation" }, index.h("ul", { "aria-label": "Pagination", class: getClassNames.getClassNames([
      ...
      ]), part: "wrapper" }, !this.hideStartEnd && (index.h("li", { class: "ld-pagination__arrow" }, index.h("ld-button", { "aria-label": this.startLabel
        ? undefined
      ...
      ]), part: "more-indicator" }, index.h("span", null, ". . ."))), index.h("li", { class: "ld-pagination__slide-wrapper", part: "slide-wrapper", style: {
      ...
      } }, index.h("li", { class: "ld-pagination__marker", key: "marker", onTransitionEnd: this.calculateSliderContent, part: "marker", style: {
