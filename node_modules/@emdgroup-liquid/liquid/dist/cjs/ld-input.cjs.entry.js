...
let LdInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl, onClick: this.handleClick }, index.h("slot", { name: "start" }), index.h("input", Object.assign({}, this.clonedAttributes, { autocomplete: this.autocomplete, onChange: this.handleChange, onInput: this.handleInput, onKeyDown: this.handleKeyDown, part: "input focusable", ref: (el) => (this.input = el), tabIndex: this.ldTabindex, value: this.value })), this.type === 'file' && (index.h("span", { class: "ld-input__placeholder", part: "placeholder" }, ((_b = this.input) === null || _b === void 0 ? void 0 : _b.value) || this.placeholder)), index.h("slot", { name: "end" })));
  }
