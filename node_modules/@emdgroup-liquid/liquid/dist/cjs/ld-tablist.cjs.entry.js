...
let LdTablist = class {
  ...
  render() {
    return (index.h(index.Host, { onKeydown: this.onKeydown.bind(this), role: "tablist" }, index.h("div", { class: getClassNames.getClassNames([
        'ld-tablist',
        this.size && `ld-tablist--${this.size}`,
        this.mode && `ld-tablist--${this.mode}`,
        this.rounded && `ld-tablist--rounded-${this.rounded}`,
      ]), part: "wrapper" }, index.h("button", { "aria-disabled": this.scrollLeftEnabled ? undefined : 'true', class: "ld-tablist__btn-scroll ld-tablist__btn-scroll--left", hidden: !this.scrollable, onClick: this.scroll.bind(this, 'left'), part: "arrow arrow-left", ref: (el) => (this.btnScrollLeftRef = el), tabindex: "-1" }, index.h("svg", { fill: "none", height: "16", part: "arrow-icon arrow-icon-left", viewBox: "0 0 16 16", width: "16", xmlns: "http://www.w3.org/2000/svg" }, index.h("title", null, "Scroll left"), index.h("path", { d: "M10 13L6 8L10 3", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }))), index.h("div", { class: "ld-tablist__scroll-container", onScroll: this.updateScrollButtons.bind(this), part: "scroll-container", ref: (el) => (this.slotContainerRef = el) }, index.h("slot", null)), index.h("button", { "aria-disabled": this.scrollRightEnabled ? undefined : 'true', class: "ld-tablist__btn-scroll ld-tablist__btn-scroll--right", hidden: !this.scrollable, onClick: this.scroll.bind(this, 'right'), part: "arrow arrow-right", tabindex: "-1" }, index.h("svg", { fill: "none", height: "16", part: "arrow-icon arrow-icon-right", viewBox: "0 0 16 16", width: "16", xmlns: "http://www.w3.org/2000/svg" }, index.h("title", null, "Scroll right"), index.h("path", { d: "M6 13L10 8L6 3", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }))))));
  }
