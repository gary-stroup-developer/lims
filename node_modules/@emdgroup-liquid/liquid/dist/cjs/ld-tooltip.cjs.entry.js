...
let LdTooltip = class {
  constructor(hostRef) {
    ...
    this.initTooltip = async () => {
      ...
      this.popper = new tether_esm.Tether({
        attachment,
