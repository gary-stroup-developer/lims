...
let LdNotice = class {
  ...
  render() {
    return (index.h(index.Host, { class: `ld-notice ld-notice--${this.mode}` }, index.h("ld-icon", { class: "ld-notice__icon", name: "info", part: "icon", size: "lg" }), this.headline && (index.h("ld-typo", { class: "ld-notice__headline", variant: "h4", tag: "p", part: "headline" }, this.headline)), index.h("slot", null)));
  }
};
