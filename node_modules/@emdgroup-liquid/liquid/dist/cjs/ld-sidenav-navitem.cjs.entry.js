...
const toggleStackToTop = require('./toggleStackToTop-e1b890cb.js');
...
let LdSidenavNavitem = class {
  ...
  render() {
    ...
    return (index.h(Tag, { part: "navitem focusable", class: cl, href: this.href, ref: (el) => (this.focusableElement = el), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, onClick: this.onClick, "aria-haspopup": this.to ? 'true' : undefined, "aria-expanded": this.to ? 'false' : undefined, tabIndex: this.ldTabindex }, index.h("div", { class: "ld-sidenav-navitem__bg", part: "bg" }, index.h("div", { class: "ld-sidenav-navitem__bg-left" }), index.h("div", { class: "ld-sidenav-navitem__bg-center" }), index.h("div", { class: "ld-sidenav-navitem__bg-right" })), index.h("div", { class: "ld-sidenav-navitem__dot", part: "dot" }), index.h("div", { class: "ld-sidenav-navitem__slot-container-icon", role: "presentation", part: "slot-container-icon" }, index.h("slot", { name: "icon" }), this.abbreviation && (index.h("span", { class: "ld-sidenav-navitem__abbr", part: "abbreviation" }, this.abbreviation)), index.h("ld-tooltip", { "show-delay": "250", tag: "span", ref: (el) => (this.tooltipRef = el), class: "ld-sidenav-navitem__tooltip", disabled: !this.sidenavCollapsed, arrow: true, position: this.sidenavAlignement === 'left' ? 'right middle' : 'left middle' }, index.h("div", { class: "ld-sidenav-navitem__tooltip-trigger", slot: "trigger", onClick: this.onClick }), index.h("div", { class: "ld-sidenav-navitem__tooltip-content" }, index.h("ld-typo", null, this.tooltipContent)))), index.h("div", { ref: (el) => (this.slotContainerRef = el), class: "ld-sidenav-navitem__slot-container", part: "slot-container" }, index.h("slot", null)), index.h("div", { class: "ld-sidenav-navitem__slot-icon-secondary-container" }, index.h("slot", { name: "icon-secondary" }))));
  }
  get el() { return index.getElement(this); }
};
LdSidenavNavitem.style = ldSidenavNavitemCss;
