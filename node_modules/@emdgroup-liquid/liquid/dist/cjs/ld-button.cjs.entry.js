...
let LdButton = class {
  ...
  render() {
    ...
    return (index.h(Tag, Object.assign({}, this.clonedAttributes, { href: this.href, "aria-busy": hasProgress ? 'true' : undefined, "aria-disabled": this.disabled || this.el.getAttribute('aria-disabled') === 'true'
        ? 'true'
        : undefined, "aria-live": "polite", class: cl, disabled: this.disabled, part: "button focusable", ref: (el) => (this.button = el), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, tabIndex: this.ldTabindex, value: this.value }), index.h("slot", null), hasProgress && (index.h("span", { class: clProgress, part: "progress-bar", style: styleProgress }))));
  }
  get el() { return index.getElement(this); }
};
LdButton.style = ldButtonCss;

exports.ld_button = LdButton;
