...
import { Component, Element, Event, h, Host, Method, } from '@stencil/core';
let tabsCount = 0;
/**
...
export class LdTabs {
  ...
  render() {
    return (h(Host, { onLdtabselect: this.handleLdtabselect, class: "ld-tabs" },
      h("slot", null)));
  }
  static get is() { return "ld-tabs"; }
  ...
  static get methods() { return {
    "switchTab": {
      "complexType": {
        "signature": "(identifier: number | string) => Promise<void>",
        "parameters": [{
            "tags": [],
            "text": ""
          }],
