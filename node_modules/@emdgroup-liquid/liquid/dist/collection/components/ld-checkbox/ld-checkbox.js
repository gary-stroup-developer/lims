...
export class LdCheckbox {
  ...
  render() {
    ...
    return (h(Host, { part: "root", class: getClassNames(cl), onClick: this.handleClick },
      h("input", Object.assign({}, this.clonedAttributes, { checked: this.checked, disabled: this.disabled, onChange: this.handleChange, onInput: this.handleInput, part: "input focusable", ref: (ref) => (this.input = ref), tabIndex: this.ldTabindex, type: "checkbox", value: this.value })),
      h("svg", { class: "ld-checkbox__check", part: "check", width: "14", height: "14", fill: "none", viewBox: "0 0 14 14", xmlns: "http://www.w3.org/2000/svg" },
