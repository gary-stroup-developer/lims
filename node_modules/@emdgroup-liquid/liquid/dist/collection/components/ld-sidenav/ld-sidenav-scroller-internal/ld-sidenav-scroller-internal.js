...
export class LdSidenavScrollerInternal {
  ...
  render() {
    ...
    return (h(Host, { class: cl, onScroll: this.updateShadows.bind(this), "data-needs-bottom": this.needsHRBottom, "data-needs-top": this.needsHRTop },
  ...
  static get originalStyleUrls() { return {
    "$": ["ld-sidenav-scroller-internal.css"]
  }; }
