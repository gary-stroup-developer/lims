...
export class LdInput {
  ...
  render() {
    ...
    return (h(Host, { class: cl, onClick: this.handleClick },
      h("slot", { name: "start" }),
      h("input", Object.assign({}, this.clonedAttributes, { autocomplete: this.autocomplete, onChange: this.handleChange, onInput: this.handleInput, onKeyDown: this.handleKeyDown, part: "input focusable", ref: (el) => (this.input = el), tabIndex: this.ldTabindex, value: this.value })),
