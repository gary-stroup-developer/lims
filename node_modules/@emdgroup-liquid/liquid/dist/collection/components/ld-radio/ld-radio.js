...
export class LdRadio {
  ...
  render() {
    ...
    return (h(Host, { part: "root", class: getClassNames(cl), onClick: this.handleClick },
      h("input", Object.assign({}, this.clonedAttributes, { part: "input focusable", onChange: this.handleChange, onInput: this.handleInput, onKeyDown: this.handleKeyDown, ref: (ref) => (this.input = ref), type: "radio", disabled: this.disabled, checked: this.checked, tabIndex: this.checked ? this.ldTabindex : -1, value: this.value })),
