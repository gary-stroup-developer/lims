...
export class LdSelect {
      ...
      h("div", { class: getClassNames(cl), "aria-disabled": this.disabled || this.ariaDisabled, part: "root", onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, style: this.expanded
        ...
        h("div", { class: "ld-select__select", part: "select", ref: (el) => (this.selectRef = el) },
          h("div", { class: getClassNames(triggerCl), role: "button", part: "btn-trigger focusable", tabindex: this.disabled && !this.ariaDisabled
              ? undefined
              : this.ldTabindex, "aria-disabled": this.disabled || this.ariaDisabled ? 'true' : 'false', "aria-haspopup": "listbox", "aria-expanded": this.expanded ? 'true' : 'false', "aria-label": triggerText, onClick: this.handleTriggerClick.bind(this), ref: (el) => (this.triggerRef = el) },
            this.multiple && this.selected.length ? (h("ul", { class: "ld-select__selection-list", part: "selection-list", "aria-label": "Selected options", ref: (el) => (this.selectionListRef = el), style: {
              ...
              return (h("li", { key: index, class: "ld-select__selection-list-item", style: { order: index + 1 + '' }, part: "selection-list-item" },
                h("label", { class: "ld-select__selection-label" },
                  ...
                  h("button", { disabled: this.disabled || this.ariaDisabled
                    ...
                    h("svg", { class: "ld-select__btn-clear-single-icon", part: "icon-clear-single", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 12 12" },
                      h("title", null, "Clear"),
            ...
            ((_b = this.selected) === null || _b === void 0 ? void 0 : _b.length) && this.multiple ? (h("button", { class: "ld-select__btn-clear", disabled: this.disabled || this.ariaDisabled ? true : undefined, onClick: this.handleClearClick.bind(this), ref: (el) => (this.btnClearRef = el), part: "btn-clear focusable" },
              h("svg", { class: "ld-select__btn-clear-icon", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 21 20", part: "icon-clear" },
            ...
            h("slot", { name: "icon" }),
            !this.hasCustomIcon && (h("svg", { class: getClassNames(triggerIconCl), role: 'presentation', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", part: "trigger-icon" },
              h("path", { stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "3", d: "M3 6l5 4 5-4" }))))),
        h("ld-select-popper", { onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, popperClass: this.popperClass, ref: (el) => (this.listboxRef = el), role: "listbox", expanded: this.expanded, size: this.size, detached: detached, theme: this.theme },
  ...
  static get properties() { return {
    ...
    "tetherOptions": {
      ...
      "docs": {
        "tags": [],
        "text": "Stringified tether options object to be merged with the default options."
      },
